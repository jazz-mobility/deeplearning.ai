...
arxiv_tool_def = {
    ...
    "function": {
        ...
        "description": "Search arXiv for academic papers. Returns titles, authors, abstracts, and links.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "The search query for finding papers on arXiv"
                },
                "max_results": {
                    "type": "integer",
...
tavily_tool_def = {
    ...
    "function": {
        ...
        "description": "Search the web for general information using Tavily. Returns titles, content snippets, and URLs.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
...
def parse_input(report):
    """
    Parse input that can be either plain text or a list of messages.
